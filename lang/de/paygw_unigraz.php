...
$string['brandname_help'] = 'Ein optionaler Name der den Namen unigraz auf der Zahlungsseite ersetzt.';
$string['cannotfetchorderdatails'] = 'Konnte keine Zahlungsdetails von unigraz erhalten. Ihr Konto wurde nicht belastet.';
$string['checkout'] = 'Checkout';
$string['clientid'] = 'Kunden ID';
$string['clientid_help'] = 'Die Kunden ID die unigraz für Ihre Seite generiert hat.';
...
$string['error'] = 'Fehler';
$string['gatewaydescription'] = 'unigraz ist ein authorisierter Zahlungsanbieter um Ihre Kreditkartenzahlung abzuwickeln.';
...
$string['paymentnotcleared'] = 'Zahlung wurde von unigraz nicht akzeptiert.';
$string['paymentoptions'] = "Zahlungsarten";
$string['pluginname'] = 'unigraz';
$string['pluginname_desc'] = 'Das unigraz plugin erlaubt es, Zahlungen mittels unigraz zu erhalten.';
$string['privacy:metadata'] = 'Das unigraz plugin speichert keine persönlichen Daten.';
...
$string['secret_help'] = 'Der access Token den unigraz für diese Anwednung bereitstellt.';
