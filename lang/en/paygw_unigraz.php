...
/**
 * Strings for component 'paygw_unigraz', language 'en'
 *
...
$string['brandname_help'] = 'An optional label that overrides the business name for the unigraz account on the unigraz site.';
$string['cannotfetchorderdatails'] = 'Could not fetch payment details from unigraz. Your account has not been debited.';
$string['checkout'] = 'Checkout';
$string['clientid'] = 'Client ID';
$string['clientid_help'] = 'The client ID that unigraz generated for your application.';
...
$string['error'] = 'Error';
$string['gatewaydescription'] = 'unigraz is an authorised payment gateway provider for processing credit card transactions.';
$string['gatewayname'] = 'unigraz';
$string['internalerror'] = 'An internal error has occurred. Please contact us.';
$string['live'] = 'Live';
$string['loading'] = 'Loading...';
$string['modulename'] = 'Payment gateway for USI Graz';
...
$string['paymentnotcleared'] = 'Payment not cleared by unigraz. Please try again later.';
$string['paymentoptions'] = "Payment options";
$string['pluginname'] = 'unigraz';
$string['pluginname_desc'] = 'The unigraz plugin allows you to receive payments via unigraz.';
$string['privacy:metadata'] = 'The unigraz plugin does not store any personal data.';
$string['proceed'] = 'Proceed';
$string['quick_checkout'] = "Quick checkout";
$string['repeatedorder'] = 'This order has already been processed earlier.';
$string['sandbox'] = 'Sandbox';
$string['secret'] = 'Secret';
$string['secret_help'] = 'The secret that unigraz generated for your application.';
